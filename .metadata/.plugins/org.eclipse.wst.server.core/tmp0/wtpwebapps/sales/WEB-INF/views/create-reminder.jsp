							...
							<div class="col-xxl">
								<div class="card mb-4">
									<div
										...
										<h5 class="mb-0">Create Reminder</h5>
										<div class="right-nav ">
											<ul>
									...
									<div class="card-body mt-4">
										<form action="save-reminder" 
											onSubmit="return validateReminderForm()" method="post">
											<div class="row">
	...
	<script type="text/javascript">
		function validateReminderForm() {
			...
			if (Remark == null || Remark == "") {
				alert("Inavlid Remark");
				return false;
			} else if (Remark.length > 100) {
				alert("Max length for Remark is 100");
				return false;
			} else if (remainderDate == null || remainderDate == "") {
				alert("Invalid reminderDate")
				return false;
			}
			return true;
		}
